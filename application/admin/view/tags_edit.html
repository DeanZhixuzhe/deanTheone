...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" method="post" action="{:url('admin/Tags/save')}">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>是否显示：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<label><input type="radio" class="input-text btn btn-default" value="1" placeholder="" name="visible" {if condition="$me.visible eq 1"}checked="checked"{/if}>显示</label>
				<label><input type="radio" class="input-text btn btn-default" value="0" placeholder="" name="visible" {if condition="$me.visible eq 0"}checked="checked"{/if}>隐藏</label>
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{$me.usname}" placeholder="" id="usname" name="usname">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{$me.dir}" placeholder="" id="dir" name="dir">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{$me.seotitle}" placeholder="" id="seotitle" name="seotitle">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{$me.description}" placeholder="" id="description" name="description">
			</div>
		</div>
