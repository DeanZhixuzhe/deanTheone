			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="f-14 td-manage">
						<a href="{:url('index/Content/index')}" target="_blank">预览</a>
						<a style="text-decoration:none" class="ml-5" onClick="layer_full('编辑','{:url('admin/Article/edit',['id'=>$vo.id])}')" href="javascript:{:url('admin/Article/edit',['id'=>$vo.id])};" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
						<a style="text-decoration:none" class="ml-5" onClick="admin_del('{:url('admin/Article/status',['id'=>$vo.id,'status'=>-1])}')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
					</td>
				</tr>
				{/volist}
			</tbody>
