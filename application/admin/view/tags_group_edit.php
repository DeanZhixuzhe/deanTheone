...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" method="post" action="{:url('admin/TagsGroup/save')}">
		...
		<div class="row cl">
			...
			<label><input type="checkbox" name="tags[]" value="{$vo.id}" {if condition="$vo.checkbox eq 1"}checked="checked"{/if}>{$vo.name}</label>
			{/volist}
		</div>
