...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" method="post" action="{:url('admin/AreaGroup/save')}">
		<div class="row cl">
			...
			<div class="formControls col-xs-7 col-sm-8 radio-box">
				<label><input type="radio" class="input-text btn btn-default" value="1" placeholder="" name="showdown" >显示</label>
				<label><input type="radio" class="input-text btn btn-default" value="0" placeholder="" name="showdown" checked="checked">隐藏</label>
			</div>
		</div>
		<div class="row cl">
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tbody>
				...
				<tr class="text-c">
					<td><input type="checkbox" value="{$vo.id}" name="area[]"></td>
					<!-- <td>{$vo.id}</td> -->
