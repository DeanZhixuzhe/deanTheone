    ...
    <div id="index_banner">
        ...
        <div data-am-widget="slider" class="am-slider am-slider-default">
            <ul class="am-slides">
                ...
                <!-- <li><a title="" href="activity_detail.html"><img src="__STATIC__/{$Think.config.website.view_style}/images/banner4.jpg"/></a></li>
                <li><a title="" href="activity_detail.html"><img src="__STATIC__/{$Think.config.website.view_style}/images/banner3.jpg"/></a></li>
                <li><a title="" href="activity_detail.html"><img src="__STATIC__/{$Think.config.website.view_style}/images/banner.jpg"/></a></li> -->
            </ul>
        </div>
    </div>
    <!--栏目-->
